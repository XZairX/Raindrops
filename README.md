...
Write a function that takes as its input a number `n` and converts it to a string, the contents of which depend on the input's numbers factors:
...
The naming of the test methods take the form of a convention encouraged by Microsoft where it is split into 3 distinct parts:
